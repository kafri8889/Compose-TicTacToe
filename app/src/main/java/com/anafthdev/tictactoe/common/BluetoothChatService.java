...
public class BluetoothChatService {
    ...
    private synchronized void updateUserInterfaceTitle() {
        mState = getState();
        Timber.tag(TAG).d("updateUserInterfaceTitle() " + mNewState + " -> " + mState);
        mNewState = mState;
    ...
    private class AcceptThread extends Thread {
        ...
        public AcceptThread(boolean secure) {
            ...
            try {
                ...
                Timber.tag(TAG).e("Socket Type: " + mSocketType + "listen() failed");
            }
            mmServerSocket = tmp;
            mState = STATE_LISTEN;
        }
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Timber.tag(TAG).e("Socket Type: " + mSocketType + "accept() failed");
                    break;
                }
                        ...
                        switch (mState) {
                            ...
                            case STATE_CONNECTED:
                                ...
                                try {
                                    ...
                                    Timber.tag(TAG).e("Could not close unwanted socket");
                                }
                                break;
                        }
                    }
        ...
        public void cancel() {
            ...
            try {
                ...
                Timber.tag(TAG).e("Socket Type" + mSocketType + "close() of server failed");
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            try {
                ...
                Timber.tag(TAG).e("Socket Type: " + mSocketType + "create() failed");
            }
            mmSocket = tmp;
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    ...
                    Timber.tag(TAG).e("unable to close() " + mSocketType +
                            " socket during connection failure", 2);
                }
                connectionFailed();
                return;
            }
        ...
        public void cancel() {
            try {
                ...
                Timber.tag(TAG).e("close() of connect " + mSocketType + " socket failed");
            }
        }
    }
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket, String socketType) {
            ...
            try {
                ...
                Timber.tag(TAG).e("temp sockets not created");
            }
